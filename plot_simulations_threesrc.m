% cd('/home/ksasha/Projects/AntiPSIICOS_beamformer/For_paper/Simulations/Three sources/Picture_threesrc_mc')
load detect_three
load r_three
load var_three
...
% subplot(4,3,9)
% plot(s(1,1:3), '-o', 'Color', c(1,:), 'LineWidth', 2, 'MarkerSize',10,...
%     'MarkerEdgeColor',c(1,:),...
%     'MarkerFaceColor',c(1,:))
% hold on
% plot(s(4,1:3), '-s', 'Color', c(6,:), 'LineWidth', 2, 'MarkerSize',10,...
%     'MarkerEdgeColor',c(6,:),...
%     'MarkerFaceColor',c(6,:))
% plot(s(3,1:3),'-*', 'Color', c(4,:), 'LineWidth', 2, 'MarkerSize',10,...
%     'MarkerEdgeColor',c(4,:),...
%     'MarkerFaceColor',c(4,:))
% ylabel('Ratio from all simulations, %')
% xticks([1 2 3 4])
% xticklabels({'3','\geq 2','\geq 1','\geq 0'})
% xlabel('Number of detected sources')
% set(gca,'FontSize', 18)
% ylim([40 100])
% 
